...
class CanChannelMonitor(QWidget):
    ...
    def _layout_widgets(self) -> None:
        ...
        control_layout.addWidget(self._mode_button)
        control_layout.addWidget(QLabel(tr("ID от")))
        control_layout.addWidget(self._filter_from)
        control_layout.addWidget(QLabel(tr("до")))
        control_layout.addWidget(self._filter_to)
        control_layout.addWidget(QLabel(tr("Искл.")))
        control_layout.addWidget(self._exclude_edit)
        control_layout.addWidget(self._known_only_check)
        ...
        send_layout.addWidget(self._send_from_dbc_button)
